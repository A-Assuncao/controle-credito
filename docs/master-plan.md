...
- **Fase atual:** Implementação em cursó (Sprint 1 / EXE-001); documentação técnica em v0.4.0-docs; `AUTORIZO CODAR` recebido em 2026-06-21.
- **Gaté atual:** aberto — Sprint 1 autorizada; código em construção na branch `sprint/001-foundation`.
